...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'twist_test.wast';
  var wasmBinaryFile = 'twist_test.wasm';
  var asmjsCodeFile = 'twist_test.temp.asm.js';
...
STATICTOP = STATIC_BASE + 7504;
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_twister_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 225;

Module['wasmMaxTableSize'] = 225;
...
var real___GLOBAL__sub_I_twister_cpp = asm["__GLOBAL__sub_I_twister_cpp"]; asm["__GLOBAL__sub_I_twister_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_twister_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_twister_cpp = Module["__GLOBAL__sub_I_twister_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_twister_cpp"].apply(null, arguments) };
